...
=======
                     "Train RMSE" = c(rmse(models$additive, loans_train),
                                      ...
                                      rmse(models$log_additive, loans_train),
                                      rmse(models$log_selected_aic, loans_train),
                                      rmse(models$log_selected_bic, loans_train),
                                      rmse(models$interactive, loans_train),
                                      rmse(models$log_interactive, loans_train)),
                     "Test RMSE" = c(rmse(models$additive, loans_test),
                                      rmse(models$selected_aic, loans_test),
                                      rmse(models$selected_bic, loans_test),
                                      rmse(models$log_additive, loans_test),
                                      rmse(models$log_selected_aic, loans_test),
                                      rmse(models$log_selected_bic, loans_test),
                                      rmse(models$interactive, loans_test),
                                      rmse(models$log_interactive, loans_test)))
>>>>>>> 0299f3041b2c8c2ac62bcf9c6460dc9c8f30bc24
