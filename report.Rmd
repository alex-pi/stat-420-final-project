...
generate_models = function(training_data, subset_model = TRUE) {
  additive = lm(interest_rate ~ . - num_cc_carrying_balance - num_historical_failed_to_pay - num_total_cc_accounts, data = training_data, subset=subset_model)
  ...
  log_additive = lm(log(interest_rate) ~ . - num_cc_carrying_balance - num_historical_failed_to_pay  - num_total_cc_accounts, data = training_data, subset=subset_model)
