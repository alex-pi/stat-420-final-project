...
## Remove 24 entries with NA dept_to_income
...
We observed the base additive models (`additive` and `log_additive`) have the fewest high-leverage observations with 278. The interaction model has the most high-leverage observations with 527.
...
To conserve space, we will only analyze the change in adjusted $R^2$ for the remaining models that will be refit. 
