...
One of the first things I notice in this VIF is the abundnace of `loan_purpose`. As loan purpose is a factor variable with 14 levels, it "clogs" the model with dummy variables. Conceptually, it also makes sense that it would be highly collinear - somebody obtaining a loan for "debt consolidation", for instance, likely has indicators of high debt in the other predictors. Thus, we will remove that variable and refit the model.
...
diags_data = data.frame(
  row.names = c("additive_diag","selected_aic_diag","selected_bic_diag","log_additive_diag","log_selected_aic_diag","log_selected_bic_diag","interactive_diag","log_interactive_diag"),
