...
gen_kable(data.frame("Predictor" = names(coef(add_refit)),
          ...
          caption = "Model Parameters Before/After Reving Influential Points.")
```
...
To conserve space, we will only analyze the change in adjusted $R^2$ here for the remaining models that will be refit. The comparison of parameters for each model can be found in the appendix.
...
gen_kable(data.frame("Predictor" = names(coef(log_aic_refit)),
          ...
          caption = "Log AIC Model Parameters Before/After Reving Influential Points")
...
gen_kable(data.frame("Predictor" = names(coef(log_bic_refit)),
          ...
          caption = "Log BIC Model Parameters Before/After Reving Influential Points")

gen_kable(data.frame("Predictor" = names(coef(int_refit)),
           "Full data" = unname(coef(models$interactive)),
           "Refit" = unname(coef(int_refit))), 
          caption = "Interactive Model Parameters Before/After Reving Influential Points")
...
gen_kable(data.frame("Predictor" = names(coef(log_int_refit)),
          ...
          caption = "Log Interactive Model Parameters Before/After Reving Influential Points")
```
